...
cad0 = "Brasil";
/* Correcto.
Se modifica el contenido de la posición en memoria a la que apunta la variable
cad0—apuntador de tipo cadena de caracteres. */
puts(cad0);
char*cad1;
gets(*cad1);    gets(cad1);

/* Incorrecto.
Ambas lecturas generan un error en la ejecución del programa
...
char*cad1 = "";
gets(cad1);
/* Correcto. Primero se le asigna un valor a la posición de memoria a la que apunta cad1. Luego podemos modificar el contenido de esta posición de memoria
...
puts(cad2);
cad2[10] = "Guatemala";
/* Incorrecto. Observa cuidadosamente el caso anterior y analiza la diferencia que existe con éste. Aquí se produce un error en la compilación del programa,
