...
charcad1[20] = ”Hola”;         /* Se asignan cuatro caracteres más el caracter
de terminación a la variable tipo charcad1. Observa que cad1 tiene espacio
para 20 caracteres.*/
charcad2[] = "México";         /* En este caso se asignan seis caracteres (más
